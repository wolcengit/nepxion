...
public class DemoIndicatorControlOutlook
	extends DemoToggleOutlook
{
	public DemoIndicatorControlOutlook()
	{
		DemoToggleActionButton frameFrameWorkButton = new DemoToggleActionButton(new DemoSlideTogglePanel());
        addButton(frameFrameWorkButton);
        
		DemoToggleActionButton dialogFrameWorkButton = new DemoToggleActionButton(new DemoSpinnerTogglePanel());
