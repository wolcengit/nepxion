...
public class TLiteLayoutExecuter
{
	private TLiteLayoutEngine layoutEngine;
	private TGraph graph;
	
	public TLiteLayoutExecuter(TGraph graph)
	{
		this.graph = graph;
	...
	public void doOrganicLayout(int length, boolean isAnimated)
	{
		...
		{
			ExceptionTracer.traceException(HandleManager.getFrame(graph), "Ö´ÐÐ²¼¾Ö³öÏÖÒì³££¬Í¼ÐÎ½á¹¹²»ÊÊÅä¸Ã²¼¾Ö", e);
		}
	}
