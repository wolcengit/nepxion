	...
	extends JPanel
{
	...
	public TLayouterPanel(final TGraph graph)
	{
		...
		widthSlider = new JSlider(1, 500, 20);
		...
		heightSlider = new JSlider(1, 500, 20);
		...
		xOffsetSlider = new JSlider(0, 2000, 150);
		...
		yOffsetSlider = new JSlider(0, 2000, 150);
	...
	{		
		...
		layouter.doLayout(layoutType, isAllElementsLayouted, isAnimated, xOffset, yOffset, width, height);
	}
}