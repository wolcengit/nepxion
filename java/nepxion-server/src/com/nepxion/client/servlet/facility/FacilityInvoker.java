package com.nepxion.client.servlet.facility;
...
public class FacilityInvoker
{
	...
	{
		ClientContext.setURI("http://localhost:8080/Nepxion-Server/FacilityXMLServlet");
		// ClientContext.setURI("http://localhost:8080/Nepxion-Server/FacilityObjectServlet");
