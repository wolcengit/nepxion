...
public class ListCheckBoxCellRenderer
	extends ListCellCheckBoxPanel implements ListCellRenderer
{
	private JList list;
	...
	public ListCheckBoxCellRenderer(JList list)
	{
		this(list, -1);
	}
	
	public ListCheckBoxCellRenderer(JList list, int fixedCellHeight)
	{
		this.list = list;
