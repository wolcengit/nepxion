...
public class ListRadioButtonCellRenderer
	extends ListCellRadioButtonPanel implements ListCellRenderer
{
	private JList list;
	private int fixedCellHeight = -1;
	
	private JRadioButton radioButton;
	private ListCellLabel cellLabel;
	
	public ListRadioButtonCellRenderer(JList list)
	{
		this(list, -1);
	}
	
	public ListRadioButtonCellRenderer(JList list, int fixedCellHeight)
	{
		this.list = list;
