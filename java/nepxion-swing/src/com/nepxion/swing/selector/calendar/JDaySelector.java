...
public class JDaySelector
    extends JPanel implements ActionListener, KeyListener, FocusListener
{
    ...
    /**
     * Default JDaySelector constructor.
     */
    public JDaySelector()
    {
        this(false);
    ...
    public JDaySelector(boolean weekOfYearVisible)
    {
        ...
        weekdayForeground = new Color(255, 255, 255);
        ...
        decorationBackgroundColor = new Color(49, 69, 99);
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            weeks[i].setBorder(BorderFactory.createEmptyBorder());
    ...
    /**
     * this is needed for JDateSelector.
     *
    ...
    /**
     * JDaySelector is the ActionListener for all day buttons.
     *
    ...
    /**
     * JDaySelector is the FocusListener for all day buttons. (Added by Thomas
     * Schaefer)
     *
     ...
     * the JDateSelector code by triggering the actionPerformed method on the next
...
//        }
    ...
    /**
     * JDaySelector is the KeyListener for all day buttons. (Added by Thomas
    ...
    /**
     * Enable or disable the JDaySelector.
     *
