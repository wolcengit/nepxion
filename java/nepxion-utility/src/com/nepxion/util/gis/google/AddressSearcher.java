	...
	extends BasicSearcher
{
	...
	public AddressSearcher(String charset)
	{
		this(ADDRESS_LANGUAGE_ZH_CN, charset);
	}	
	
	public AddressSearcher(String addressLanguage, String charset)
	{
		super(charset);
	...
	public GisEntity getGeo(double latitude, double longitude)
	{
	...
	public static void main(String[] args)
	{
		...
		GisEntity gisEntity = addressSearcher.getGeo(30.16932, 120.160527);
