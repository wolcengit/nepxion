...
public class GeoCoordinateSearcher
	extends BasicGeoSearcher
{
	...
	public GeoCoordinateSearcher()
	{
		this(true);
	}
	
	public GeoCoordinateSearcher(String charset)
	{
		this(true, ADDRESS_LANGUAGE_ZH_CN, charset);
	}
	
	public GeoCoordinateSearcher(boolean requestAddress)
	{
		this(requestAddress, ADDRESS_LANGUAGE_ZH_CN);
	}	
	
	public GeoCoordinateSearcher(boolean requestAddress, String addressLanguage)
	{
		this(requestAddress, addressLanguage, "UTF-8");
	}	
	
	public GeoCoordinateSearcher(boolean requestAddress, String addressLanguage, String charset)
	{
		super(charset);
	...
	{
		GeoCoordinateSearcher geoCoordinateSeeker = new GeoCoordinateSearcher();
