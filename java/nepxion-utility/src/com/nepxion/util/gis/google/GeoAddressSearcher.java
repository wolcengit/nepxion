...
public class GeoAddressSearcher
	extends BasicGeoSearcher
{
	protected String addressLanguage = ADDRESS_LANGUAGE_ZH_CN;
	
	public GeoAddressSearcher()
	{
		this("UTF-8");
	}	
	
	public GeoAddressSearcher(String charset)
	{
		this(ADDRESS_LANGUAGE_ZH_CN, charset);
	}	
	
	public GeoAddressSearcher(String addressLanguage, String charset)
	{
		super(charset);
	...
	{
		GeoAddressSearcher geoAddressSeeker = new GeoAddressSearcher();
		
		Geo geo = geoAddressSeeker.getGeo(30.16932, 120.160527);
