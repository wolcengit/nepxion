...
public class GeoAddressSeeker
	extends BasicGeoParser
{
	protected String addressLanguage = ADDRESS_LANGUAGE_ZH_CN;
	
	public GeoAddressSeeker()
	{
		this("UTF-8");
	}	
	
	public GeoAddressSeeker(String charset)
	{
		this(ADDRESS_LANGUAGE_ZH_CN, charset);
	}	
	
	public GeoAddressSeeker(String addressLanguage, String charset)
	{
		super(charset);
	...
	{
		GeoAddressSeeker geoAddressSeeker = new GeoAddressSeeker();
