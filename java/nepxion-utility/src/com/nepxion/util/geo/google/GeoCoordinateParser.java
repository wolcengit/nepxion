	...
	extends BasicGeoParser
{
	...
	public GeoCoordinateParser()
	{
		this(true);
	}
	
	public GeoCoordinateParser(String charset)
	{
		this(true, ADDRESS_LANGUAGE_ZH_CN, charset);
	}
	
	public GeoCoordinateParser(boolean requestAddress)
	{
		this(requestAddress, ADDRESS_LANGUAGE_ZH_CN);
	}	
	
	public GeoCoordinateParser(boolean requestAddress, String addressLanguage)
	{
		this(requestAddress, addressLanguage, "UTF-8");
	}	
	
	public GeoCoordinateParser(boolean requestAddress, String addressLanguage, String charset)
	{
		super(charset);
