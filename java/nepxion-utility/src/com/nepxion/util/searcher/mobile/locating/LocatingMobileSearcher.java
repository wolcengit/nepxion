	...
	implements LocatingMobileConstants
{
		...
		throws Exception
	{
		...
		clientParameters.add(new ClientParameter("m", mobile));
		clientParameters.add(new ClientParameter("output", "xml"));
		clientRequestPost.setParameterEntity(clientParameters, charset);
